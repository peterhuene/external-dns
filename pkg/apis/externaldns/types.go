...
func (cfg *Config) ParseFlags(args []string) error {
	...
	app.Flag("provider", "The DNS provider where the DNS records will be created (required, options: aws, google, azure)").Required().PlaceHolder("provider").EnumVar(&cfg.Provider, "aws", "google", "azure")
